# ✨ Web-Devlopment
A comprehensive collection of my web development journey, featuring core concepts, projects, and learning notes.
...
## 📖 Learning Path
<details>
<summary><strong>Phase 1: Frontend Fundamentals</strong></summary>
...
<details>
<summary><strong>Phase 2: Backend Development</strong></summary>
...
<details>
<summary><strong>Phase 3: Backend Development </strong></summary>
...
1.  **Clone the repository**:
    ```bash
    git clone https://github.com/Uttamsaini15/Web-Devlopment.git
    cd Web-development
    ```
...
3.  **Backend Setup**:
    ```bash
    cd "Web-Development/Back-End/NodeJS"
    npm install
    node script.js
